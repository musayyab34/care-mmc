...
| 3 | **Team members** | ✅ Done | `team.html` shows Lisa Fuentes-Tidona (President & Managing Partner), Rajni Roy (VP of Operations & Partner), and Chinasa Chudi-Attah (VP of Clinical Services & Partner) with bios + photos |
| 4 | **Gallery photos** | ✅ Done | `gallery.html` shows 3 real photos (chronic, palliative, home care). The team group photo was removed at the client's request — it already appears on About and the Team page |
...
| 16 | **"How It Works" section** | ✅ Done | Added to `index.html` between Services Overview and Why Choose Us — 4 steps (Call us → We listen → We build your care plan → We coordinate your care) |
